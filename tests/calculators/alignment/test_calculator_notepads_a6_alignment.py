"""
Calculator Alignment Test: Notepads A6
========================================
"""
...
class TestCalculatorNotepadsA6Alignment:
    """Test schema-wrapper-backend alignment for Notepads A6 Calculator"""
    ...
    def test_03_print_variations(self):
        result_single = calculate_notepads_a6(quantity=100, print_sides="Single side print")
        result_double = calculate_notepads_a6(quantity=100, print_sides="Double side print")
    ...
    def test_04_quantity_enum(self):
        for qty in [25, 50, 100, 250, 500, 1000]:
            result = calculate_notepads_a6(quantity=qty)
            assert result["success"] == True
    
    def test_05_paper_stock_options(self):
        stocks = ["Uncoated Bond 80GSM", "Uncoated Bond 90GSM", "Standard"]
        for stock in stocks:
            result = calculate_notepads_a6(quantity=100, paper_stock=stock)
            assert result["success"] == True
    
    def test_06_artworks_pricing(self):
        result1 = calculate_notepads_a6(quantity=100, artworks=1)
        result2 = calculate_notepads_a6(quantity=100, artworks=3)
        assert result2["total_price"] > result1["total_price"]
    
    def test_07_colour_vs_bw(self):
        result_colour = calculate_notepads_a6(quantity=100, print_type="Colour")
        result_bw = calculate_notepads_a6(quantity=100, print_type="Black & White")
    ...
    def test_09_minimum_params(self):
        result = calculate_notepads_a6(quantity=100)
        assert result["success"] == True
    
    def test_10_price_consistency(self):
        result1 = calculate_notepads_a6(quantity=250)
        result2 = calculate_notepads_a6(quantity=250)
        assert result1["total_price"] == result2["total_price"]
    
    def test_11_legacy_vs_new(self):
        result_new = calculate_notepads_a6(quantity=100, paper_stock="Standard")
        result_legacy = calculate_notepads_a6(quantity=100, stock_type="Standard")
