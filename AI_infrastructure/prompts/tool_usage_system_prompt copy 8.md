...
---
TOOL ECOSYSTEM = HOW YOU ACCESS AND USE 646 TOOLS
═
...
- `search_tools("create document")` - Search across all 646 tools by keyword
...
- `get_available_queries(category)` - Browse 60+ pre-built queries
...
**Pre-Built Query Library (60+ Queries):**
