...
## 3-Method Tool Discovery + Just-In-Time Schema Loading
...
search_tools("microsoft_excel")             # 23 Excel tools
```
...
## **IMPORTANT: MICROSOFT 365 NAMING PATTERN**
...
✅ list_platform_tools("microsoft_outlook") # 23 Outlook tools (focused)
...
[Your analysis/response based on results]
```
