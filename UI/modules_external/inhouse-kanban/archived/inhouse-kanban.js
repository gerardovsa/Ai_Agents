...
class InhouseKanbanModule extends BaseModule {
    ...
    createSubTabNavigation() {
        ...
        const navHtml = `
            <div class="module-sub-tabs" style="background: #1A1F2E; border-bottom: 2px solid ${primaryColor}; padding: 0 20px; display: flex; gap: 4px;">
                <button class="sub-tab-btn active" data-tab="workboard" onclick="window.currentKanbanModule.switchSubTab('workboard')">
                    <i class="fas fa-industry"></i>
                    <span>Production Workboard</span>
                </button>
                <button class="sub-tab-btn" data-tab="analytics" onclick="window.currentKanbanModule.switchSubTab('analytics')">
    ...
    switchSubTab(tabName) {
        ...
        document.querySelectorAll('.module-sub-tabs .sub-tab-btn').forEach(btn => {
        ...
        return `
            <div class="kanban-card${cardStyles.pulseClass}" 
                ...
                <div class="card-meta">
                    ...
                    ${job.Qty && job.ProductType ? `<div class="card-quantity">Qty: ${job.Qty} - ${this.escapeHtml(job.ProductType)}</div>` : ''}
                </div>
