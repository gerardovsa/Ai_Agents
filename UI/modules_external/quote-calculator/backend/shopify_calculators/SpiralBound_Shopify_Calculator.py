...
- CONDITIONAL: $98.63 when NO printed back cover, $44 when WITH printed back cover
"""
...
class SpiralBoundBooksShopifyCalculator:
    ...
    Formula: {total} = (BizCost + (BizCost × profitMargin)) × 1.15 + surcharge
    
    CRITICAL DISCOVERIES (Jan 26, 2026):
    1. JavaScript uses F4.price (front cover stock) for BOTH front and back covers
    2. Surcharge is CONDITIONAL: $98.63 (no back) vs $44 (with back)
    """
    ...
    def calculate(self,
        ...
        15. Apply 15% GST
        16. Add CONDITIONAL surcharge ($98.63 or $44)
        """
