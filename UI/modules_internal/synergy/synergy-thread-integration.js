...
if (window.ThreadCardRegistry && typeof window.ThreadCardRegistry.registerBadgeRenderer === 'function') {
    window.ThreadCardRegistry.registerBadgeRenderer('synergy_sessions', {
        condition: 'thread.synergy_card_id !== null',
        renderFunction: 'window.SynergyThreadIntegration.renderThreadBadge',
        config: {
        ...
        placeholderClick: 'ThreadManager.openSynergySyncModal'
    });
    console.log('[SynergyThreadIntegration] Registered with ThreadCardRegistry');
} else {
    console.warn('[SynergyThreadIntegration] ThreadCardRegistry not available yet');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        if (window.ThreadCardRegistry && typeof window.ThreadCardRegistry.registerBadgeRenderer === 'function') {
            ...
            console.log('[SynergyThreadIntegration] Registered with ThreadCardRegistry (deferred)');
        }
    });
}
