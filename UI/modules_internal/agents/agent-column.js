...
const AgentColumn = (function () {
    ...
    function renderEmptyState(agentId, agentName) {
        return `
            <div class="empty-state" style="display: flex; align-items: flex-start; justify-content: center; padding: 24px 16px; text-align: center;">
                <div style="line-height: 1.6; max-width: 500px;">
                    ...
                    <div style="background: rgba(255, 255, 255, 0.05); padding: 12px; border-radius: 8px; border-left: 3px solid var(--accent-primary, #667eea); margin-bottom: 14px; text-align: left;">
