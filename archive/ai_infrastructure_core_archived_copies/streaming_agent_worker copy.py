...
class StreamingAgentWorker:
    ...
    def _build_messages(
        ...
        for idx, msg in enumerate(conversation_history):
            ...
            # CRITICAL FIX: Parse string content that might contain serialized blocks
            # Frontend sometimes sends messages with string content that were previously serialized
