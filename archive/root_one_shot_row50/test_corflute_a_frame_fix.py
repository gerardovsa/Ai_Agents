"""Test Corflute Insert A-Frame Alignment (Jan 23, 2026)"""
import sys
...
from calculator_wrapper import calculate_corflute_insert_a_frame

print("=" * 80)
print("CORFLUTE INSERT A-FRAME ALIGNMENT TEST")
print("=" * 80)

# Test 1: JSON format
print("\n✅ Test 1: JSON format - 10 qty, 600mm(W) x 900mm(H)")
result1 = calculate_corflute_insert_a_frame(
    quantity=10,
...
result2 = calculate_corflute_insert_a_frame(quantity=10, size="600x450", artworks=1)
