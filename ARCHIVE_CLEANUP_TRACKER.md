...
| 48 | `.github/` directory cleanup | docs | The 40+ files. Cross-link to canonical docs; archive superseded analyses; retire `copilot-instructions.md.disabled`; **process `copilot-instructions.md` LAST** (row 49). | claude-row48-2026-06-12 | 2026-06-12 | IN PROGRESS | cleanup/github-cleanup | Branch created; inventory done. 41 top-level .md (1 already archived) + 1 .py + 1 .disabled + 1 active copilot-instructions.md (skip) + 27 prompts + 3 prompts/archive + 1 analysis + 2 workflows. **Canonical to keep** (7): ORG_CREDENTIALS_MASTER_ANALYSIS, VECTOR_DB_DEVELOPER_REFERENCE, VECTOR_DB_ORG_ALIGNMENT, MODULE_VISIBILITY_ARCHITECTURE, SVG_CAD_GENERATION_RULES, AI_DOCUMENTATION_CONSOLIDATION_INSTRUCTIONS, plus copilot-instructions.md (row 49). **Archive with _ARCHIVED_ prefix (34)**: all CALCULATOR_*, GROUP_*, QUICK_START_GROUP_*, plus ACCOUNT_PROFILE_UI_ANALYSIS, AUTH_FLOW_AND_ONBOARDING, DATABASE_PATH_FIX_COMPLETE, DOCUMENTATION_UPDATE_JAN19_2026, EMAIL_FOOTER_FILTERING, META_TOOLS_*, MODULE_REDESIGN_SPEC, PERSONAL_ORG_SYNERGY_IMPLEMENTATION_PLAN, SHORT_DESCRIPTION_DESIGN_GUIDE, TEAMS_SYSTEM_EMAIL_MODEL, THREAD_VISIBILITY_*, plus analysis/BATCHED_RENDERING_ANALYSIS. **Retire (1)**: copilot-instructions.md.disabled → archive/copilot_instructions_disabled/. **Keep active**: TEST_TEMPLATE.py, prompts/ (27), prompts/archive/ (3), workflows/ (2). |
