...
| F4 | discovered post-row-42 | **1,236 root `.md` files** need audit (DOC GAP — not covered by any of the 49 rows) | docs | ~~RESOLVED by row 51 (DONE, June 12, 2026). 1,225 archived, 11 kept. See row 51 above.~~ |
...
| F6 | row 49 | Stale HTML link rot in `archive/timelines_and_reports/ai_agents_timeline.html` | docs | **1,094 stale cross-references** to docs that have been moved/archived. The HTML itself is in `archive/` (read-only per the cleanup contract); the broken refs are low-impact. Captured in row 49 findings doc §4.3 for followup. Not blocking; defer until next cleanup round. |
