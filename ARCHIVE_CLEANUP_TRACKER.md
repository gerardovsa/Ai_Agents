...
| 46 | `docs/` directory consolidation | docs | The 15 .md at root + subdirs. Promote what should be canonical. Move dated fix logs to `docs/archive/`. | claude-row46-2026-06-11 | 2026-06-11 | CLAIMED | cleanup/docs-consolidation | |
