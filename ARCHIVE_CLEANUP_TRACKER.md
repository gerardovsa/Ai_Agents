...
| 41 | `AI_infrastructure/core/archived/` freeze verification | code | Confirm no live imports. Document the freeze. | claude-row41-2026-06-12 | 2026-06-12 | IN PROGRESS | cleanup/core-archived-freeze | Branch created off `cleanup/migration-trees-audit`. Per CLAUDE.md §2 + §13.12: this dir is documented as frozen ("Do not import from"). Audit verifies the freeze is intact. |
