...
| 43 | Top-level "integration" directories | meta | `Woocommerce/`, `Cloudflare/`, `Render_backend/`, `Supabase/`, `Microsoft_365_Connection/`, `google_workspace/`, `tslot_bed_frame_docs/`, `temp_v9_comparison/`. For each: is anything imported from here? Is the content archived elsewhere? | claude-row43-2026-06-12 | 2026-06-12 | IN PROGRESS | cleanup/integration-dirs-audit | Branch created. **2 KEEP (load-bearing)**: `google_workspace/` (20 files, 925K, 4+ live route/core importers) and `Microsoft_365_Connection/` (5 files, 116K, 1 live route importer). **6 ARCHIVE** (no active imports): `Woocommerce/` 1 file/68K, `Cloudflare/` 20/138K, `Render_backend/` 68/809K, `Supabase/` 12/164K, `tslot_bed_frame_docs/` 5/24K, `temp_v9_comparison/` 5/196K. **4 files extract from Microsoft_365_Connection/** to archive (4 of 5 files in dir are not imported by any code: email_sender.py, microsoft365_client.py, quote_request_processor.py, test_email_integration.py — only microsoft365_oauth_manager.py is live). CLAUDE.md line 139 wording is wrong (lists Microsoft_365_Connection/ and google_workspace/ as 'historical' when they're actually active) — needs update. |
