...
| 42 | Top-level `tests/` cleanup | code+docs | `run_group*.py`, `test_all_calculators*.py`, `test_*.py` (calculator tests). Trace each. | claude-row42-2026-06-12 | 2026-06-12 | IN PROGRESS | cleanup/top-tests-cleanup | Branch created off `cleanup/core-archived-freeze`. Heuristic: not imported anywhere, not in `.vscode/tasks.json`, not in `.github/workflows/`, last modified >6 months. |
