...
Based on: c:/Users/gpoli/GIT/In_House_SQL/G_Folder/Quote_Calculator/shopify/Shopify_Notepads_A5.json specification
...
class NotepadsA5ShopifyCalculator:
    ...
    CONFIG_FILE = r"c:\Users\gpoli\GIT\In_House_SQL\G_Folder\Quote_Calculator\shopify\Shopify_Notepads_A5.json"
    ...
    def calculate(self, **kwargs) -> NotepadsA5ShopifyCalculatorQuoteResult:
        """
        Calculate Notepads A5 Shopify quote
        ...
        # Notepads A5: assume 2 pads per sheet
        items_per_sheet = Decimal('2')
        stock_cost_per_1000_sheets = Decimal('95')

        stock_waste = Decimal('1.07')
        ...
        glue_cost_per_pad = Decimal('0.18')
