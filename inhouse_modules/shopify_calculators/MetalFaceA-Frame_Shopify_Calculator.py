...
@dataclass
class MetalFaceA_FrameShopifyCalculatorQuoteResult:
...
class MetalFaceA_FrameShopifyCalculator:
    """
    ...
    CONFIG_FILE = "Shopify_Metal_Face_A_Frame.json"
    ...
    def calculate(self, **kwargs) -> MetalFaceA_FrameShopifyCalculatorQuoteResult:
        """
        ...
        a_frame_hardware = Decimal('6.00') * Decimal(quantity)
        ...
        return MetalFaceA_FrameShopifyCalculatorQuoteResult(
            total_price=total_price,
